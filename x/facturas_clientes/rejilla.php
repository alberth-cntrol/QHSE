				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td width="6%"><div align="center"><a href="#"><img src="../img/modificar.png" width="16" height="16" border="0" onClick="modificar_factura(<?php echo mysqli_result($res_resultado,$contador,"codfactura")?>,<? echo $marcaestado?>)" title="Modificar"></a></div></td>
							<td width="6%"><div align="center"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" onClick="ver_factura(<?php echo mysqli_result($res_resultado,$contador,"codfactura")?>)" title="Visualizar"></a></div></td>
							<td width="6%"><div align="center"><a href="#"><img src="../img/eliminar.png" width="16" height="16" border="0" onClick="eliminar_factura(<?php echo mysqli_result($res_resultado,$contador,"codfactura")?>)" title="Eliminar"></a></div></td>
						</tr>
						<? $contador++;
							}
						?>			
