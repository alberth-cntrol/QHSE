...
<html>
	<head>
		...
		function aceptar(codentidad) {
			location.href="guardar_entidad.php?codentidad=" + codentidad + "&accion=baja" + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="botonBusqueda">
					<img src="../img/botonaceptar.jpg" width="85" height="22" onClick="aceptar(<? echo $codentidad?>)" border="1" onMouseOver="style.cursor=cursor">
