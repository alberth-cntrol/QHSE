...
$select_albaranes="SELECT codalbaran,totalalbaran,codproveedor,iva FROM albaranesp WHERE codalbaran IN (".$albaranes.") AND codproveedor='$codproveedor'";
$rs_albaranes=mysqli_query($descriptor,$select_albaranes); 
